...
AddEventHandler("vRP:playerSpawn", function(user_id, source, first_spawn)
  ...
  if first_spawn then -- first spawn
    ...
    -- notify last login
    TriggerClientEvent("pNotify:SendNotification",player,{text = "<b style='color:#1E90FF'>Bem-Vindo ao Morro Do Juramento Roleplay</b> <br /><br />Pressione K para acessar o menu do jogador. <br/>Entre no nosso discord: https://discord.gg/QRuD2V9 <br />", type = "info", timeout = (3000),layout = "centerLeft"})
