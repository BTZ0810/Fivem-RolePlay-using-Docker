    ...
    vRP.getUserIdentity(user_id, function(identity)
      ...
      if identity then
        ...
        vRP.getUserAddress(user_id, function(address)
          ...
          local content = lang.cityhall.menu.info({htmlEntities.encode(identity.name),htmlEntities.encode(identity.firstname),identity.age,identity.registration,identity.phone,home,number,job,money,bmoney})
          local choices = {}
