...
cfg.gaptitudes = {
  ["physical"] = {
    _title = "Fisico",
    ["strength"] = {"Força", 6, 275} -- required, level 3 to 6 (by default, can carry 10kg per level)
  },
  ["science"] = {
    _title = "Ciencia",
    ["quimica"] = {"Estudo de produtos químicos", 0, 1000}, -- example
    ["matematica"] = {"Estudo de Matematica", 0, 1000} -- example
  }
}
