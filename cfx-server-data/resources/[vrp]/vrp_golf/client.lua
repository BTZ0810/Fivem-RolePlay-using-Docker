...
Citizen.CreateThread(function()
	...
	while true do
		...
		DrawMarker(20,-1332.7823486328,128.18229675293,56.052, 0, 0, 0, 0, 0, 0, 1.5, 1.5, 10.3, 0, 519, 0, 105, 0, 0, 2, 0, 0, 0, 0)
		--end
...
function idleShot()
	...
	while golfstate == 2 do
		...
		DrawMarker(20,holes[golfhole]["x2"],holes[golfhole]["y2"],holes[golfhole]["z2"], 0, 0, 0, 0, 0, 0, 0.5, 0.5, 10.3, 212, 189, 0, 105, 0, 0, 2, 0, 0, 0, 0)
...
function addblipGC()
	...
	SetBlipColour(gcblip, 8)
	SetBlipAsShortRange(gcblip,true)
	BeginTextCommandSetBlipName("STRING");
	AddTextComponentString(tostring("~p~Golf Course"))
