...
local n1_policia_armas = {}
n1_policia_armas["ARSENAL NÍVEL 1"] = {function(player,choice)
...
n1_policia_armas["COLETE"] = {function(player,choice)
    BMclient.setArmour(player,{100,true})
end}

local n2_policia_armas = {}
n2_policia_armas["ARSENAL NÍVEL 2"] = {function(player,choice)
    vRPclient.giveWeapons(player,{{
	  ["WEAPON_COMBATPISTOL"] = {ammo=200},
...
n2_policia_armas["COLETE"] = {function(player,choice)
    BMclient.setArmour(player,{100,true})
end}

local n3_policia_armas = {}
n3_policia_armas["ARSENAL NÍVEL 3"] = {function(player,choice)
    vRPclient.giveWeapons(player,{{
	  ["WEAPON_COMBATPISTOL"] = {ammo=200},
...
n3_policia_armas["COLETE"] = {function(player,choice)
    BMclient.setArmour(player,{100,true})
end}

local n4_policia_armas = {}
n4_policia_armas["ARSENAL NÍVEL 4"] = {function(player,choice)
    vRPclient.giveWeapons(player,{{
	  ["WEAPON_PISTOL50"] = {ammo=200},
	  ["WEAPON_HEAVYSHOTGUN"] = {ammo=200},
	  ["WEAPON_CARBINERIFLE_MK2"] = {ammo=200},
	}, true})
end}
n4_policia_armas["COLETE"] = {function(player,choice)
    BMclient.setArmour(player,{100,true})
end}

local n5_policia_armas = {}
n5_policia_armas["ARSENAL NÍVEL 5"] = {function(player,choice)
    vRPclient.giveWeapons(player,{{
	  ["WEAPON_PISTOL50"] = {ammo=200},
...
n5_policia_armas["COLETE"] = {function(player,choice)
    BMclient.setArmour(player,{100,true})
end}
...
emergency_medkit["Kit Médico"] = {function(player,choice)
	local user_id = vRP.getUserId({player}) 
	vRP.giveInventoryItem({user_id,"medkit",25,true})
end}
emergency_medkit["Arsenal"] = {function(player,choice)
    vRPclient.giveWeapons(player,{{
	  ["WEAPON_FIREEXTINGUISHER"] = {ammo=99999},
	  ["WEAPON_FLASHLIGHT"] = {ammo=1},
	  ["WEAPON_FLARE"] = {ammo=20},
	  ["WEAPON_STUNGUN"] = {ammo=200}
	}, true})
end}

local uberEATS_item1 = {}
uberEATS_item1["Pegar 10 Coca-Cola"] = {function(player,choice)
	local user_id = vRP.getUserId({player}) 
	vRP.giveInventoryItem({user_id,"cocacola",10,true})
end}
local uberEATS_item2 = {}
uberEATS_item2["Pegar 10 Big Tasty"] = {function(player,choice)
	local user_id = vRP.getUserId({player}) 
	vRP.giveInventoryItem({user_id,"bigtasty",10,true})
end}
local gariItem = {}
gariItem["Pegar 10 Sacos de Lixo"] = {function(player,choice)
	local user_id = vRP.getUserId({player}) 
	vRP.giveInventoryItem({user_id,"saco_lixo",10,true})
end}
local minItem = {}
minItem["Pegar 10 Picaretas"] = {function(player,choice)
	local user_id = vRP.getUserId({player}) 
	vRP.giveInventoryItem({user_id,"picareta",10,true})
end}
local correiosItem = {}
correiosItem["Pegar 10 Sedex"] = {function(player,choice)
	local user_id = vRP.getUserId({player}) 
	vRP.giveInventoryItem({user_id,"pacote",10,true})
end}
local mcItem = {}
mcItem["Pegar 10 Hamburguers"] = {function(player,choice)
	local user_id = vRP.getUserId({player}) 
	vRP.giveInventoryItem({user_id,"hamburguer",10,true})
end}
...
vRP.addStaticMenuChoices({"n1_policia_armas", n1_policia_armas}) -- police gear
vRP.addStaticMenuChoices({"n2_policia_armas", n2_policia_armas}) -- police gear
vRP.addStaticMenuChoices({"n3_policia_armas", n3_policia_armas}) -- police gear
vRP.addStaticMenuChoices({"n4_policia_armas", n4_policia_armas}) -- police gear
vRP.addStaticMenuChoices({"n5_policia_armas", n5_policia_armas}) -- police gear
...
vRP.addStaticMenuChoices({"uberEATS_item1", uberEATS_item1}) -- heal button
vRP.addStaticMenuChoices({"uberEATS_item2", uberEATS_item2}) -- heal button
vRP.addStaticMenuChoices({"gariItem", gariItem})
vRP.addStaticMenuChoices({"minItem", minItem})
vRP.addStaticMenuChoices({"correiosItem", correiosItem})
vRP.addStaticMenuChoices({"mcItem", mcItem})
