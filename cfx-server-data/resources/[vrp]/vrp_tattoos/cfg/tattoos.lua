...
cfg.tattoos = {
	["mpbeach_overlays"] = { -- native store name
		_config = {blipid=75,blipcolor=8,title="~p~Beach Tattoos"}, -- you can add permissions like on other vRP features
	...
	["mpbusiness_overlays"] = {
		_config = {blipid=75,blipcolor=8,title="~p~Business Tattoos"},
		["CLEAR"] = {">Clear Tattoos",500,""},
	...
	["mphipster_overlays"] = {
		_config = {blipid=75,blipcolor=8,title="~p~Hipster Tattoos"},
		["CLEAR"] = {">Clear Tattoos",500,""},
