...
cfg.seconds = 6000 -- seconds to rob
...
cfg.holdups = { -- list of stores
	...
	["sandyshores_twentyfourseven"] = {
		...
		reward = 12500 + math.random(2500,6000),
		nameofstore = "Twenty Four Seven. (Sandy Shores)",
		lastrobbed = 0
	},
	["grapeseed_gasstop"] = {
	...
	["delperro_robsliquor"] = {
		...
		reward = 22500 + math.random(7500,10000),
