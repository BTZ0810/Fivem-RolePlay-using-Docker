...
AddEventHandler("vRP:playerSpawn",function(user_id, source, first_spawn)
  if first_spawn then
    -- add job display getUserByPhone
    vRPclient.setDiv(source,{"hora",cfg.display_css,""})
    --vRPclient.setDiv(source,{"hora",cfg.display_css,vRP.getUserByPhone({user_id,"phone"})})
