                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.php">
                            <img src="https://i.imgur.com/MdPe3DO.png" width=190 height=100/>
                        </a>
                    </div>
                    <div class="right-div">
                        ...
                        <div class="col-md-12">
                            <div class="navbar-collapse collapse ">
                                <ul id="menu-top" class="nav navbar-nav navbar-right">
                                    ...
                                    <li>
                                        <a href="add_criminal.php">Adicionar Crime</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="content-wrapper">
                <div class="container">
                    <div class="row pad-botm">
                        <div class="col-md-12">
                            <h4 class="header-line">Policia Militar Painel</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
                   &copy; 2018 TRAXRP |
            <a href="" target="_blank"  > Feito By : VictorKiller</a>
        </div>
    </div>
